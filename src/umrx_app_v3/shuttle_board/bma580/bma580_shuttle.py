...
from umrx_app_v3.sensors.bma580 import BMA580, BMA580Addr, BMA580ExtendedAddr

logger = logging.getLogger(__name__)


class BMA580ShuttleError(Exception): ...
...
class BMA580Shuttle:
    ...
    def check_connected_hw(self) -> None:
        ...
        if board_info.shuttle_id != self.SHUTTLE_ID:
            ...
            raise BMA580ShuttleError(error_message)
    ...
    def read_register(self, reg_addr: int, bytes_to_read: int = 1) -> array[int] | int:
        if isinstance(reg_addr, BMA580Addr | BMA580ExtendedAddr):
    ...
    def _configure_i2c_polling_streaming(
        ...
        self.board.streaming_polling_set_i2c_channel(
            ...
            register_address=BMA580Addr.acc_data_0.value,
            bytes_to_read=(6 + 1 + 3),
        )
    ...
    def _configure_i2c_interrupt_streaming(self) -> None:
        self.board.streaming_interrupt_set_i2c_channel(
            ...
            i2c_address=BMA580Shuttle.I2C_DEFAULT_ADDRESS,
            register_address=BMA580Addr.acc_data_0.value,
            bytes_to_read=(6 + 1 + 3),
        )
