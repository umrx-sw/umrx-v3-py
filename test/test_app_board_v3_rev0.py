...
def test_app_board_30_construction(app_board_30: ApplicationBoardV3Rev0):
    assert isinstance(app_board_30, ApplicationBoardV3Rev0), "Expecting instance of ApplicationBoard30"
    assert isinstance(app_board_30.protocol, BstProtocol), "Expecting BST protocol object inside App Board 3.0"


@pytest.mark.app_board
def test_app_board_v30_board_info(app_board_30: ApplicationBoardV3Rev0):
