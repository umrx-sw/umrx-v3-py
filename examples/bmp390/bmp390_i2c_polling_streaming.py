...
if __name__ == "__main__":
    ...
    for idx in range(1000):
        for streaming in shuttle.board.receive_polling_streaming_multiple():
            ...
            pressure_b0, pressure_b1, pressure_b2, temp_b0, temp_b1, temp_b2, time_b0, time_b1, time_b2 = struct.unpack("<BBBBBBxxBBB", payload)
            ...
            logger.info(
                f"[{idx=:03d}], pressure(Pa)={compensated_pressure:7.3f}, temperature(C)={compensated_temperature:3.3f}, "
